...
from graph_nn_vae.data import DiagonalRepresentationGraphDataModule, RealGraphLoader
...
class GraphAutoencoder(RecurrentGraphAutoencoder):
    ...
    def add_model_specific_args(parent_parser: ArgumentParser):
        ...
        parser.set_defaults(
            ...
            batch_size=32,
            embedding_size=256,
            encoder_hidden_layer_sizes=[2048, 1024],
            encoder_activation_function="ELU",
            decoder_hidden_layer_sizes=[2048, 1024],

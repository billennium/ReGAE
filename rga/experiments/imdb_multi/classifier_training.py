...
class ExperimentModel(RecursiveEncoderGraphClassifier):
    ...
    def add_model_specific_args(parent_parser: ArgumentParser):
        ...
        parser.set_defaults(
            ...
            gpus=1,
            freeze_encoder=True,
            checkpoint_path="/home/adam/phd/recursive-graph-autoencoder/tb_logs/RecursiveGraphAutoencoder/IMDB-MULTI/version_0/checkpoints/epoch=329-step=14189-v1.ckpt",
        )
        return parser
